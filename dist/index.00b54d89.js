(function () {
  ...
  $33facf3a10dcd13e701fe0db3b29cb29$export$register(JSON.parse("{\"4yryz\":\"index.00b54d89.js\",\"5SO2e\":\"avajpg.2c590b34.jpg\",\"6noaP\":\"loadbleach.91482f8b.svg\",\"3AfLj\":\"avatar.2e526632.jpg\",\"vED5i\":\"img.1ca8cd8f.png\"}"));
  ...
  var $7b94ccf1c932ae1a723091ae744a1cc8$var$HeaderContainer = /*#__PURE__*/function (_React$Component) {
    ...
    $7b94ccf1c932ae1a723091ae744a1cc8$var$_createClass(HeaderContainer, [{
      ...
      value: function componentDidMount() {
        ...
        $7b94ccf1c932ae1a723091ae744a1cc8$var$axios.get("https://social-network.samuraijs.com/api/1.0/auth/me").then(function (response) {
          console.log({
            response: response
          });
          debugger;
